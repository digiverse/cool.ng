...
if (WINDOWS)
  ...
  elseif( ${MSVC_VERSION} MATCHES "1910" )
    set( COOL_NG_MSVC "15" )
  elseif( ${MSVC_VERSION} MATCHES "1920" )
    set( COOL_NG_MSVC "16" )
  else()
...
target_compile_definitions( cool.ng-dev PRIVATE COOL_NG_BUILD COOL_NG_STATIC_LIBRARY )
target_compile_definitions( cool.ng-dyn-dev PRIVATE COOL_NG_BUILD )
